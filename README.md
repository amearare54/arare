...
| 左手・スティック | トラックパッドの代わりとして載せています。2 本指・3 本指でするような操作を、親指ひとつでできるように、というつもりです。倒したぶんだけポインタが動き、押し込みが左クリックです。 |
...
| ポインタ | スティック アナログXY (AIN2/AIN3) ＋ 押込=D10直結キー | PAW3222 (spi1: SCK=P1.13 SDIO=P1.14 CS=P1.15 MOTION=P0.09) |
